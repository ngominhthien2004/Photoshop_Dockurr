...
## Thành phần được lưu trong repo
- `docker-compose.yml`
- `Dockerfile_wine` (thử nghiệm)
- `Enable-Remote-Access.ps1`
- `input-output/*.bat`, `input-output/*.reg`
- Tài liệu: `BAO-CAO-DU-AN.md`, `huongdan.md`, `directory-tree.txt`

## Thành phần KHÔNG lưu trong repo
- `windows-data/` (disk runtime rất lớn)
- `Data/` (cache/profile/runtime)
- `App/Photoshop/`, `Photoshoр.exe`, `input-output/Photoshop/` (binary/asset không phù hợp để public repo)
